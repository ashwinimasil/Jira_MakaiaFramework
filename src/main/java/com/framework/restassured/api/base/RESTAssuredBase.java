...
public class RESTAssuredBase extends PreAndTest {
	...
	public static Response putWithBodyParam(String key, String jsonObject, String URL) {
	...
	public static void verifyContentsWithKey(Response response, String key, String expVal) {
		...
		public static Response postWithBodyAsKeyAndUrl(String key, String jsonObject, String url) {
			
			return setLogs().header("key",key).body(jsonObject).post(url);
